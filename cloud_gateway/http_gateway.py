...
def rpc_handler(function_name):
    register_event("cloud_gateway","rpc_handler",f"Started redirecting {function_name} msg",allow_registering=allow_register,host=rpc_hostname,port=rpc_port)
    ...
    try:
        ...
        register_event("cloud_gateway","rpc_handler",f"Finished redirecting {function_name} msg",allow_registering=allow_register,host=rpc_hostname,port=rpc_port)
